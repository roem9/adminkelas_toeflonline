$(document).on("click", ".addItem, #addItem .btnBack", function(){
    ...
    if(latihan == "Latihan Kosa Kata"){
        html = `
        <div class="mb-3">
            <label class="form-label">Pilih Item</label>
            <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="item" value="kosa kata" class="form-selectgroup-input">
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                        <div class="me-3">
                            <span class="form-selectgroup-check"></span>
                        </div>
                        <div>
                            Tambah Soal Kosa Kata
                        </div>
                    </div>
                </label>
            </div>
        </div>`;
    } else if(latihan == "Koreksi Manual") {
        html = `
            <div class="mb-3">
                <label class="form-label">Pilih Item</label>
                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
        ...
        if(item == "kosa kata"){
            html += `
                <div class="form-floating mb-3">
                    <textarea name="kata_indo" class="form-control required" data-bs-toggle="autosize" placeholder="Type something…"></textarea>
                    <label for="" class="col-form-label">Kata (Indonesia)</label>
                </div>
                <div class="form-floating mb-3">
                    <textarea name="kata_asing" class="form-control required" data-bs-toggle="autosize" placeholder="Type something…"></textarea>
                    <label for="" class="col-form-label">Kata (Asing)</label>
                </div>
                `
            ...
            <div class="form-floating mb-3">
                <textarea name="jawaban" class="form-control `+require+`" data-bs-toggle="autosize" placeholder="Type something…"></textarea>
                <label for="" class="col-form-label">Jawaban</label>
            </div>`;
...
$(document).on("click", "#addItem .btnAdd", function(){
    ...
    if(item == "kosa kata"){
        Swal.fire({
            icon: 'question',
            text: 'Yakin akan menambahkan kosa kata baru?',
            ...
            if (result.value) {
                ...
                let kata_indo = $(form+" [name='kata_indo']").val();
                let kata_asing = $(form+" [name='kata_asing']").val();
                let penulisan = "LTR";
                ...
                if( eror == 1){
                    ...
                    let data_soal = `{"kata_indo":"`+kata_indo+`","kata_asing":"`+kata_asing+`"}`;
                    let data = {id_pertemuan:id_pertemuan, tipe_soal:tipe_soal, item:item, data_soal:data_soal, penulisan:penulisan};
                    let result = ajax(url_base+"program/add_item_latihan", "POST", data);
                    if(result == 1){
                        Swal.fire({
                            position: 'center',
                            icon: 'success',
                ...
                // console.log(id_pertemuan, tipe_soal, item, soal, pilihan_a, pilihan_b, pilihan_c, pilihan_d, jawaban, penulisan);
            }
        })
    } else if(item == "soal"){
        Swal.fire({
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                if( eror == 1){
                    ...
                    let data = {id_pertemuan:id_pertemuan, tipe_soal:tipe_soal, item:item, data_soal:soal, penulisan:penulisan};
                    let result = ajax(url_base+"program/add_item_latihan", "POST", data);
                    if(result == 1){
                        Swal.fire({
                            position: 'center',
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    if( eror == 1){
                        ...
                        $.ajax({
                            url: url_base+'program/add_item_latihan',
                            type: 'post',
                            data: fd,
                            contentType: false,
                            processData: false,
...
$(document).on("click", ".hapusItem", function(){
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            let result = ajax(url_base+"program/hapus_item", "POST", data);
...
$(document).on("click", ".editItem", function(){
    ...
    let result = ajax(url_base+"program/get_item_latihan", "POST", data);
    ...
    if(result.item == "soal") {
        ...
        html = `
            <div class="form-floating mb-3">
                <textarea name="kata_indo" class="form-control required" data-bs-toggle="autosize" placeholder="Type something…">`+result.kata_indo+`</textarea>
                <label for="" class="col-form-label">Kata (Indonesia)</label>
            </div>
            <div class="form-floating mb-3">
                <textarea name="kata_asing" class="form-control required" data-bs-toggle="autosize" placeholder="Type something…">`+result.kata_asing+`</textarea>
                <label for="" class="col-form-label">Kata (Asing)</label>
            </div>`
        ...
        html = `
            ...
            <div class="form-floating mb-3">
                <textarea name="jawaban" class="form-control `+require+`" data-bs-toggle="autosize" placeholder="Type something…">`+result.jawaban+`</textarea>
                <label for="" class="col-form-label">Jawaban</label>
            </div>`;
...
$(document).on("click", "#editItem .btnEdit", function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                if( eror == 1){
                    ...
                    let result = ajax(url_base+"program/edit_item_latihan", "POST", data);
                    if(result == 1){
                        Swal.fire({
                            position: 'center',
                            icon: 'success',
    ...
    } else if(item == "kosa kata"){
        Swal.fire({
            icon: 'question',
            text: 'Yakin akan mengubah kosa kata?',
            showCloseButton: true,
            showCancelButton: true,
            confirmButtonText: 'Ya',
            cancelButtonText: 'Tidak'
...
$(document).on("click", ".saveUrutan", function(){
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            let data = {id_item:id_item};
            let result = ajax(url_base+"program/edit_urutan_latihan_pertemuan", "POST", data)
            if(result == 1){
                load_item(id)
                Swal.fire({
                    position: 'center',
