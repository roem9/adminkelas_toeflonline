            ...
            if(data.item == "petunjuk"){
                ...
                item = `
                    <div class="d-flex justify-content-center">
                        <img src="`+url_base+`assets/media/`+data.data+`?t=`+Math.random()+`" onerror="this.onerror=null; this.src='`+url_base+`assets/tabler-icons-1.39.1/icons/x.svg'" class="img-fluid" height='auto' width='30%'>
                    </div>`
            } else if(data.item == "video" || data.item == "video pembahasan"){
                item = `
                    <div class="d-flex justify-content-center">
                ...
                if(data.item == "video pembahasan"){
                    item += `<span><b>video pembahasan</b></span>`
                }
            }
