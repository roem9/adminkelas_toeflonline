                                ...
                                <div class="shadow card mb-3 soal">
                                    <div class="card-body">
                                        ...
                                        <p class='text-center'>
                                            ...
                                            <span class='text-center' style='font-size: 5em;'><b><?= $jawaban['nilai']?> / <?= jumlah_soal($pertemuan['id_pertemuan'])?></b></span>
                                        </p>
                                    </div>
                                </div>
                            </div>

                            <div class="row row-cards FieldContainer pembahasan" data-masonry='{"percentPosition": true }'>
